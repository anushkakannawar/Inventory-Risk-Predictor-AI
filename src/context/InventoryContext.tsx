  ...
  const runAnalysis = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      skus.forEach(sku => {
        ...
        // Reconstruct params (simplified version of what analyzeRisk does internally)
        const params = {
          id: sku.id,
          name: sku.name,
          currentStock: sku.currentInventory,
          avgDailySales: sku.dailySalesRate,
          leadTime: sku.leadTimeDays,
          reorderQuantity: sku.reorderQuantity,
          volatility: sku.salesVariability / 100,
          unitCost: sku.unitCost,
          sellingPrice: sku.unitCost * 1.5 // Consistent with simulation assumption
        };
        saveSimulation(params, analysis.simulationResult);
      });
